...
namespace DAL.Repositories
{
    ...
    {
        public void UpdateStockById(int idProduct, int amount)
        {
        ...
        public DataTable GetCateogyProducts()
        {
            var cnn = new DbConnectionFactory();
        ...
        public List<Product> GetAll()
        {
            ...
            {
                products.Add(ProductMapper.Map(r));
            }
        ...
        public string GetCategoryById(int idCategory)
        {
            var cnn = new DbConnectionFactory();
            using (var connection = cnn.OpenConnection())
