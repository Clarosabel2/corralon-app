...
namespace DAL.Repositories
{
    ...
    {
        public List<BE_Family> GetAllByType(bool isSystem)
        {
        ...
        public List<BE_Permission> GetAllByFamily(string idFamily)
        {
            var cnn = new DbConnectionFactory();
            var cmd = new SqlCommand();
            cmd.Connection = cnn.OpenConnection();
        ...
        private BE_Permission GetComponent(string id, IList<BE_Permission> list)
        {
        ...
        public void Save(BE_Family profile)
        {
            var cnn = new DbConnectionFactory();
            var cmd = new SqlCommand();
            cmd.Connection = cnn.OpenConnection();
        ...
        public void Update(BE_Family profile)
        {
            var cnn = new DbConnectionFactory();
            var cmd = new SqlCommand();
            cmd.Connection = cnn.OpenConnection();
        ...
        private void DeleteChildrenRecursively(SqlCommand cmd, IList<BE_Permission> children)
        {
        ...
        private void InsertChildrenRecursively(SqlCommand cmd, string parentId, IList<BE_Permission> children)
        {
            foreach (var child in children)
            {
        ...
        public void Delete(BE_Family profile)
        {
            var cnn = new DbConnectionFactory();
            var cmd = new SqlCommand();
            cmd.Connection = cnn.OpenConnection();
